...
const schema = z.object({
  ...
  // `angles`: la persona ya aceptó la línea y pide verla contada desde otros
  // ángulos. No es un defecto a reparar: es otra pregunta (ver AIBulletModule).
  focus: z.array(z.enum(["metric", "weak_verb", "cliche", "passive", "angles"])).max(3).optional(),
