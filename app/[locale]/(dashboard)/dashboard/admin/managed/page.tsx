...
export const metadata = { title: "Admin — Managed Users", robots: { index: false, follow: false } }

export default async function AdminManagedPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params
  const t = await getTranslations({ locale, namespace: "dashboard_admin.managed" })
