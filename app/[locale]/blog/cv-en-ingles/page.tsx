        ...
        <div className="grid lg:grid-cols-[1fr_280px] gap-10 lg:gap-14">
          <article className="min-w-0">
            <BlogProse>
              ...
              <p>
                Más del 75% de los resumes recibidos por empresas Fortune 500 pasan por un sistema ATS antes de que un humano los abra. Para un CV en inglés esto añade dos retos extra al hispanohablante:
              </p>
            ...
            <div className="mt-16">
              <BlogCTA
                ...
                description="ReadyCV PRO incluye 111+ plantillas optimizadas para ATS internacional, sugerencias AI en inglés (US y UK) y el ATS Checker que valida tu match contra cualquier job description. Empieza en menos de 2 minutos."
