  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        es: `https://www.valhallaresume.com/es/blog/adaptar-cv-oferta-trabajo`,
          ...
          <article className="min-w-0">
            ...
            <div className="mt-16">
              ...
              <BlogCTA
                ...
                description="Valhalla Resume PRO&apos;s tailor-cv feature reads the job description, reorders your skills and bullets, runs the ATS check and produces a tailored resume on any of 132 ATS-verified templates — all in under three minutes per application."
