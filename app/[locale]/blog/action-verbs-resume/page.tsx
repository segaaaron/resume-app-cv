  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        es: `https://www.valhallaresume.com/es/blog/verbos-de-accion-cv`,
          ...
          <article className="min-w-0">
            ...
            <div className="mt-16">
              ...
              <BlogCTA
                ...
                description="Valhalla Resume PRO&apos;s AI bullet editor rewrites your experience with verb-first structure, scope-matched intensity and embedded metrics — in seconds, across 132 ATS-verified templates."
