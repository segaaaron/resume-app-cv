...
const SLUG = "que-es-ats-y-por-que-rechaza-tu-cv"
...
export default async function ATSArticlePage({
  ...
  const t = await getTranslations("blog_ats")
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <Script id="article-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        publisher: { "@type": "Organization", name: "Valhalla Resume", logo: { "@type": "ImageObject", url: "https://www.valhallaresume.com/og-image.png" } },
