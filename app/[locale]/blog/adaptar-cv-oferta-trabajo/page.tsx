  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        en: `https://readycvv.com/en/blog/how-to-tailor-resume`,
        "x-default": `https://readycvv.com/en/blog/how-to-tailor-resume`,
      },
    },
    openGraph: {
      title: t("title"),
          ...
          <article className="min-w-0">
            ...
            <div className="mt-16">
              <BlogCTA
                ...
                description="La función tailor-cv de ReadyCV PRO lee la oferta de trabajo, reordena tus habilidades y bullets, corre el chequeo ATS y produce un CV adaptado sobre cualquiera de 111+ plantillas ATS-verificadas — todo en menos de tres minutos por postulación."
