...
export default function KyotoTemplate() {
  ...
  return (
    <div style={{ display: "flex", minHeight: "297mm", fontFamily: "inherit", backgroundColor: "#fff", fontWeight: 300 }}>
      {/* SIDEBAR */}
      <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              {workExperience.map((job) => (
                <div key={job.id} className="resume-entry">
                  ...
                  {job.description && (
                    <div style={{ fontSize: "9.5px", color: "#4b5563", lineHeight: 1.65, fontWeight: 300 }}
