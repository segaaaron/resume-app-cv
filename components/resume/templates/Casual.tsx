      ...
      <div className="flex px-10 pt-6 pb-8 gap-7">
        ...
        <div className="flex-1">
          {visible("summary") && summary && (
            <Section id="summary" title={L.aboutMe} color={color}>
        ...
        <div className="w-44 shrink-0">
          {visible("skills") && skills.length > 0 && (
            <Section id="skills" title={L.skills} color={color}>
          ...
          {(pd.website || pd.linkedin) && (
            <Section id="links" title="Links" color={color}>
          ...
          {visible("hobbies") && hobbies && (
            <Section id="hobbies" title={L.interests} color={color}>
