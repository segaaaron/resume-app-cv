          ...
          {(() => {
            ...
            return (
              <div style={{ width: 70, height: 70, borderRadius: "50%", border: "3px solid " + cyan, flexShrink: 0, backgroundColor: headerDark, display: "flex", alignItems: "center", justifyContent: "center" }}>
                {config.photoUrl ? <img src={config.photoUrl} alt="" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: `center ${config.photoPosition ?? 15}%`, borderRadius: "inherit" }} /> : <span style={{ color: cyan, fontWeight: 900, fontSize: 22 }}>{initials || "N"}</span>}
              </div>
            )
          })()}
          <div>
