...
const TEMPLATE_MAP: Record<string, React.ComponentType> = {
  ...
  atsivory:              dynamic(() => import("./templates/AtsIvory"),              { ssr: false, loading }),
  ...
  "luxe-aurum":          dynamic(() => import("./templates/LuxeAurum"),             { ssr: false, loading }),
  ...
  "exec-oxblood":        dynamic(() => import("./templates/ExecOxblood"),           { ssr: false, loading }),
  "exec-cobalt":         dynamic(() => import("./templates/ExecCobalt"),            { ssr: false, loading }),
  "exec-terra":          dynamic(() => import("./templates/ExecTerra"),             { ssr: false, loading }),
