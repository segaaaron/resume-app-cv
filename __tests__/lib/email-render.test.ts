...
const TEMPLATES: Record<string, (locale: string) => [string, string]> = {
  ...
  managedWelcome: (l) => [managedWelcomeHtml({ password: "x9Y!", expiresAt: D, downloadLimit: 5, loginUrl: "https://www.valhallaresume.com/es/login", locale: l }), managedWelcomeText({ password: "x9Y!", expiresAt: D, downloadLimit: 5, loginUrl: "https://www.valhallaresume.com/es/login", locale: l })],
