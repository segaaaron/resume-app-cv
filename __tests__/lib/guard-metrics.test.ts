...
const base = { endpoint: "tailor-cv", offered: 10, kept: 7, hardCoded: 1, figureLoss: 1, trivial: 1, termLoss: 0, weak: 0 }

describe("reportGuardDrops", () => {
  beforeEach(() => sink.mockClear())

  it("no escribe nada cuando la corrida no descartó nada", () => {
    reportGuardDrops({ ...base, kept: 10, hardCoded: 0, figureLoss: 0, trivial: 0, termLoss: 0, weak: 0 })
